...
```
**Notes:
Mutate- babysex, frace, malform, and mrace to their defined character from hw
Mutate- baby length from cm to inches
Make model between birthweight and gestational age
